...
Gem::Specification.new do |gem|
  ...
  gem.description   = 'Filter ip by region/country/continent to grant access.
   Typically for DRM. Based on Chris Trinh gem (https://github.com/elentras/ip_filter),
   I rewrite / review code and choose to keep this version under my own git
   account'
